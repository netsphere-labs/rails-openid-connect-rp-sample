...
class Auth::GoogleCodeflowController < ApplicationController
  # POST /auth/google
  def create
    ...
    redirect_to Auth::GoogleCodeflow.authorization_uri(
  ...
  def callback
    ...
    if login(Auth::GoogleCodeflow, params[:code], nonce, verifier) 
